    ...
    const onlineHandler = async () => {
        try {
          ...
          const init = await stripe.initPaymentSheet({
            ...
            merchantDisplayName: "MarketoEcom",
          });
        ...
        <View style={ {...defaultStyle} }>
            ...
            <View style={styles.container}>
                ...
                >
                    <View style={styles.radioStyle}>
                        ...
                        <RadioButton color={"#17B169"} value={"COD"} />
                    </View>
                    <View style={styles.radioStyle}>
                        <Text style={styles.radioStyleText}>Online</Text>
                        <RadioButton color={"#17B169"} value={"ONLINE"} />
                    </View>
                </RadioButton.Group>
            </View>
            ...
            >
                <Button
                    ...
                    icon={
                        paymentMethod === "COD" ? "check-circle" : "credit-card-outline"
                    }
                >
